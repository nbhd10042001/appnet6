...
namespace App.Areas.Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {     
                        ...
                        AutoConfirmModel _modelAutoConf = new AutoConfirmModel();
                        _modelAutoConf.id = user.Id.ToString();
                        _modelAutoConf.code = code.ToString();
                        return View("RegisterConfirmation", _modelAutoConf);
                    }
                    else
                    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public IActionResult RegisterConfirmation(AutoConfirmModel model)
        {  
            return View();
        }    
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(model.Email != externalEmail)
                {
                    ModelState.AddModelError(string.Empty, "Email nhap phai giong voi Email tu dich vu ngoai");
                    return View();
                }

                // Check user <input email> was exist? and user <email external> was exist in database
